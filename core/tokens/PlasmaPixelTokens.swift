// Plasma Pixel tokens — GENERATED from tokens.json. Do not edit.
...
public enum PP {
    ...
    public enum Motion {
        ...
        public static let minDuration: Double = 3
    ...
    public enum Typeface {
        public static let display = "Silkscreen"
        public static let prose = "IBM Plex Mono"
